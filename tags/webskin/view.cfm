...
<cfif thistag.executionMode eq "Start">
	...
	<cfparam name="attributes.view" default=""><!--- the webskin to be called with the object --->
	...
	<cfset lAttributes = "stobject,typename,objectid,key,template,view,webskin,stprops,stparam,r_html,r_objectid,hashKey,alternateHTML,onExitProcess,dsn,bAjax,ajaxID,ajaxShowloadIndicator,ajaxindicatorText,ajaxURLParameters,bIgnoreSecurity,bAllowTrace,ftWrapElement" />
	<cfset attrib = "" />
	...
	<cfif len(attributes.view)>
		<cfset attributes.webskin = attributes.view />
	</cfif>
	...
	<cfif not len(attributes.typename)>
		...
		<cfelseif structKeyExists(CALLER, "stobj")>
			<cfset attributes.objectid = CALLER.stobj.objectid>
			<cfset attributes.typename = CALLER.stobj.typename>
		</cfif>
	</cfif>
